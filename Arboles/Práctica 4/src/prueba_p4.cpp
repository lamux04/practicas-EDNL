...
void prueba_interseccion_conjuntos()
{
    Conjunto<int> A;
    A.insertar(3);
    A.insertar(4);
    ...
    Conjunto<int> C(InterseccionConjuntos(A, B));
    imprimirElementos(C);
}

void prueba_operador_especial()
{
    Conjunto<int> A;
    A.insertar(3);
    A.insertar(4);
    ...
    imprimirElementos(UnionConjuntos(A, B));
    imprimirElementos(InterseccionConjuntos(A, B));
    imprimirElementos(OperadorEspecial(A, B));
}