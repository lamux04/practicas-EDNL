#ifndef AbinRel_E_S_H
#define AbinRel_E_S_H
...
template <typename T>
void rellenarAbin(AbinRel<T>& A, const T& fin)
// Pre: A está vacío.
...
template <typename T>
void rellenarDescendientes(typename AbinRel<T>::nodo n, AbinRel<T>& A, const T& fin)
...
//       usando fin para introducir nodos nulos.
{
   ...
   assert(A.hijoIzqdo(n) == AbinRel<T>::NODO_NULO &&
          A.hijoDrcho(n) == AbinRel<T>::NODO_NULO);
...
template <typename T>
void rellenarAbin(istream& is, AbinRel<T>& A)
// Pre: A está vacío.
...
template <typename T>
void rellenarDescendientes(istream& is, typename AbinRel<T>::nodo n, AbinRel<T>& A, const T& fin)
// Pre: n es un nodo hoja de A.
...
template <typename T>
void imprimirAbin (const AbinRel<T>& A)
...
template <typename T>
void imprimirDescendientes (typename AbinRel<T>::nodo n, const AbinRel<T>& A)
// Post: Muestra los descendientes de n en la salida estándar.
{
   ...
   if (A.hijoDrcho(n) != AbinRel<T>::NODO_NULO)
   {
...
template <typename T>
void imprimirAbin (ostream& os, const AbinRel<T>& A, const T& fin)
...
template <typename T>
void imprimirDescendientes (ostream& os, typename AbinRel<T>::nodo n, const AbinRel<T>& A, const T& fin)
